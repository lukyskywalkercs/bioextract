...
if not run_button:
    table_placeholder.markdown(
        ...
        '</div>'
        '</div>'
        '<p style="font-size:12px;color:var(--muted);line-height:1.5;font-style:italic;margin:0;">'
        'No evalúa calidad metodológica ni reemplaza la lectura del paper original.'
        '</p>'
        '</div>',
        unsafe_allow_html=True
    )
    with st.expander("Ver ejemplo de salida", expanded=False):
        st.markdown(
            '<div style="font-size:10px;font-weight:600;color:var(--muted);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:6px;">Input</div>'
            ...
            '</div>'
            '<div style="font-size:10px;font-weight:600;color:var(--muted);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:10px;">Output</div>'
            '<div style="display:flex;flex-direction:column;gap:9px;">'
            '<div style="font-size:13px;color:var(--ink-2);line-height:1.6;">✅ <span style="color:var(--ink);font-weight:500;">Veredicto:</span> Extracción completa — 100%</div>'
            '<div style="font-size:13px;color:var(--ink-2);line-height:1.6;"><span style="color:var(--ink);font-weight:500;">Entidades:</span> capivasertib · fulvestrant · HR-positive HER2-negative metastatic breast cancer</div>'
            '<div style="font-size:13px;color:var(--ink-2);line-height:1.6;"><span style="color:var(--ink);font-weight:500;">Métricas:</span> HR=0.60 &middot; CI [0.51&#8211;0.71] &middot; p&lt;0.001</div>'
            '<div style="font-size:13px;color:var(--ink-2);line-height:1.6;"><span style="color:var(--ink);font-weight:500;">Tipo de estudio:</span> RCT clínico fase III</div>'
            '</div>',
            unsafe_allow_html=True
        )
